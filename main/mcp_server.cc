...
void McpServer::AddCommonTools() {
    ...
    if (music) {
        ...
        AddTool("self.music.play_song",
            "当用户说'来一首'、'播放'、'放歌'、'听歌'、'放首歌'、'放音乐'、'播放音乐'、'播放歌曲'、'放一首歌'、'来一首歌'、'放首'、'来首'、'播放一首'、'放一首'、'听一首'、'放歌听'、'放音乐听'、'播放歌曲听'、'放歌来听'、'放音乐来听'、'播放歌曲来听'、'放歌给我听'、'放音乐给我听'、'播放歌曲给我听'、'放歌听一下'、'放音乐听一下'、'播放歌曲听一下'、'放歌来听一下'、'放音乐来听一下'、'播放歌曲来听一下'、'放歌给我听一下'、'放音乐给我听一下'、'播放歌曲给我听一下'、'放歌听一听'、'放音乐听一听'、'播放歌曲听一听'、'放歌来听一听'、'放音乐来听一听'、'播放歌曲来听一听'、'放歌给我听一听'、'放音乐给我听一听'、'播放歌曲给我听一听'时，必须立即调用此工具。这是播放音乐的唯一方法，不要只是说会播放音乐，必须调用此工具才能实际播放。"
            "参数:"
