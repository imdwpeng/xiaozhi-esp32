...
// 触摸按键配置 (基于 ESP32-S3 GPIO映射 - 尝试不同配置)
#define TOUCH_BUTTON_LEFT_GPIO    TOUCH_PAD_NUM9   // 左侧触摸按键 - 上一个屏幕
#define TOUCH_BUTTON_RIGHT_GPIO   TOUCH_PAD_NUM10  // 右侧触摸按键 - 下一个屏幕  
#define TOUCH_BUTTON_CENTER_GPIO  TOUCH_PAD_NUM8   // 中间触摸按键 - 确认操作
